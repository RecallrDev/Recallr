...
const DeckCard = ({ deck, onStudy, onEdit }: DeckCardProps) => {
  return (
      ...
      <div className="p-6">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 text-white px-3 py-2 rounded flex items-center justify-center gap-2 hover:opacity-90 transition-all font-medium disabled:opacity-50"
            style={{ backgroundColor: deck.color }}
